...
export const luggageFields: ProfileField[] = [
  ...
  { name: 'quickPick' as keyof ProfileFormData, label: 'Pass Type', type: 'radio', required: true, colSpan: 2, options: [ { value: 'DayPass', label: 'Day pass' }, { value: 'LongStay', label: 'Long Stay Pass' } ] },
