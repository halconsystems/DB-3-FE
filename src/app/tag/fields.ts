...
export const tagFields: ProfileField[] = [
  { name: 'tagId' as keyof ProfileFormData, label: 'Tag ID', type: 'text', required: true, placeholder: 'Tag ID here' },
  ...
  { name: 'vendorId' as keyof ProfileFormData, label: 'Vendor ID', type: 'text', required: true, placeholder: 'Vendor ID here' },
];
