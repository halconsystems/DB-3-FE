...
export const workerFields: ProfileField[] = [
  ...
  { name: 'cardNo' as keyof ProfileFormData, label: 'Card No. / ID', type: 'text', required: false, placeholder: 'e.g. 1234 5678 1234 5678' },
  ...
  { name: 'cardStatus' as keyof ProfileFormData,  label: 'Tag Status',  type: 'statusSwitch',  required: false },
  { name: 'status' as keyof ProfileFormData,  label: 'Worker Status',  type: 'statusSwitch',  required: false },
